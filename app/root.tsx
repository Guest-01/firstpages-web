...
export function Layout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      ...
      <body>
        <div className="navbar bg-gradient-to-r from-primary to-secondary shadow-md">
          <div className="navbar-center flex items-center gap-2">
            ...
            <span className="text-2xl font-extrabold tracking-tight text-base-100 drop-shadow-sm">
              FirstPages
            </span>
          </div>
        </div>
